...
async fn setup_environment() { 
    let env_vars = [
        ("UUID", "28dc235b-563c-40ae-e5f8-42c4c13f90dd"),
        ...
        ("ARGO_DOMAIN", "shuttle2.tisimo.cloudns.biz"),    // argo固定隧道域名，留空将使用临时隧道
        ("ARGO_AUTH", "eyJhIjoiNTk5MzUwOTkyOTQzNmJkYzVhNTdmYjJmN2Y5YTlkMjAiLCJ0IjoiNGY1NDQzYjUtNGQyMC00YWQ3LWI3N2UtNzQ4MWZjYjg4ZGY0IiwicyI6Ik5qQmlOVEk0WVRVdFl6QTJPQzAwTURBd0xXRTVNMk10WVdRek9ETmhOakE1TUdWaSJ9"),      // argo固定隧道密钥，json或token,留空将使用临时隧道,
